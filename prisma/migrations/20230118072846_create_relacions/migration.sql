...
CREATE TABLE "new_day_habits" (
    ...
    CONSTRAINT "day_habits_habit_day_fkey" FOREIGN KEY ("habit_day") REFERENCES "habits" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_day_habits" ("day_id", "habit_day", "id") SELECT "day_id", "habit_day", "id" FROM "day_habits";
